...
Tecnotek.StudentQualifications = {
    translates : {},
    init : function() {
        ...
        $("#period").change(function(event){
            ...
            Tecnotek.StudentQualifications.loadGroupsOfPeriod($(this).val());
        });

        $("#groups").change(function(event){
            event.preventDefault();
            Tecnotek.StudentQualifications.loadGroupStudents($(this).val());
        });

        $("#students").change(function(event){
            event.preventDefault();
            Tecnotek.StudentQualifications.loadQualificationsOfGroup($(this).val());
        });

        Tecnotek.StudentQualifications.loadGroupsOfPeriod($('#period').val());
        Tecnotek.StudentQualifications.initButtons();
    },
            ...
            Tecnotek.ajaxCall(Tecnotek.UI.urls["loadGroupsOfPeriodURL"],
                ...
                function(data){
                    if(data.error === true) {
                        ...
                        Tecnotek.StudentQualifications.loadGroupStudents($('#groups').val());
                    }
                },
