...
$.include(assetsURL + 'js/superfish.js')
$.include(assetsURL + 'js/FF-cash.js')
$.include(assetsURL + 'js/tms-0.4.x.js')
$.include(assetsURL + 'js/uCarausel.js')
$.include(assetsURL + 'js/jquery.easing.1.3.js')
$.include(assetsURL + 'js/jquery.tools.min.js')
$.include(assetsURL + 'js/jquery.jqtransform.js')
$.include(assetsURL + 'js/jquery.quicksand.js')
$.include(assetsURL + 'js/jquery.snippet.min.js')
$.include(assetsURL + 'js/jquery-ui-1.8.17.custom.min.js')
$.include(assetsURL + 'js/jquery.cycle.all.min.js')
$.include(assetsURL+ 'js/jquery.cookie.js')
$(function(){
